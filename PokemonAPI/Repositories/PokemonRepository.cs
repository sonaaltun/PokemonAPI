...
namespace PokemonAPI.Repository
{
    public class PokemonRepository : IPokemonRepository
    {
        ...
        public bool CreatePokemon(Guid ownerId, Guid categoryId, Pokemon pokemon)
        {
        ...
        public decimal GetPokemonRating(Guid pokeId)
        {
        ...
        public bool PokemonExists(Guid pokeId)
        {
